...
ALTER TABLE List ADD CONSTRAINT PK_List PRIMARY KEY (idList, idProfile);
...
ALTER TABLE EpisodeManager CHANGE COLUMN idEpisodeManager idEpisodeManager INT NOT NULL AUTO_INCREMENT;
...
ALTER TABLE Message ADD CONSTRAINT FK_Message_ProfileSender FOREIGN KEY (idSender) REFERENCES Profile(idProfile);
ALTER TABLE Message ADD CONSTRAINT FK_Message_ProfileReceiver FOREIGN KEY (idReceiver) REFERENCES Profile(idProfile);
